    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">Quality First</h3>
              <p className="text-gray-600 leading-relaxed mb-4 font-sans">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">Made with Care</h3>
              <p className="text-gray-600 leading-relaxed mb-4 font-sans">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">A Place to Belong</h3>
              <p className="text-gray-600 leading-relaxed mb-4 font-sans">
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 font-serif">What Makes Us Different</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">The Cherdung Cafe experience</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 font-serif">Freshly Prepared Food</h3>
                  <p className="text-gray-600 font-sans">Every dish is made to order using the freshest ingredients, ensuring maximum flavor and quality in every bite.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 font-serif">Carefully Selected Coffee</h3>
                  <p className="text-gray-600 font-sans">We source our beans from the finest coffee-growing regions, expertly roasted to bring out the perfect flavor profile.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 font-serif">Comfortable Atmosphere</h3>
                  <p className="text-gray-600 font-sans">Our space is designed to be your second home – cozy, welcoming, and perfect for work, relaxation, or socializing.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 font-serif">Friendly Service</h3>
                  <p className="text-gray-600 font-sans">Our team genuinely cares about your experience, providing warm, personalized service that makes you feel valued.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 font-serif">Attention to Detail</h3>
                  <p className="text-gray-600 font-sans">From the temperature of your coffee to the presentation of your food, we obsess over the details that matter.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-amber-50 py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 font-serif">Our Menu & Experience</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">More than just food – it's the complete Cherdung experience</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 font-serif">Specialty Coffee</h3>
              <p className="text-gray-600 font-sans">Expertly crafted espresso drinks, pour-over coffee, and signature beverages made with premium beans.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 font-serif">Fresh Food</h3>
              <p className="text-gray-600 font-sans">From hearty breakfasts to light lunches and delicious dinners, our menu features dishes made with love.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 font-serif">Desserts</h3>
              <p className="text-gray-600 font-sans">Indulge in our selection of freshly baked pastries, cakes, and sweet treats perfect for any time of day.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 font-serif">Casual Meetings</h3>
              <p className="text-gray-600 font-sans">A perfect spot for business meetings, study sessions, or casual catch-ups with friends and colleagues.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 font-serif">Family & Friends</h3>
              <p className="text-gray-600 font-sans">Create lasting memories with family gatherings, birthday celebrations, and quality time together.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3 font-serif">Small Events</h3>
              <p className="text-gray-600 font-sans">Host intimate gatherings, workshops, or small celebrations in our warm and welcoming space.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 font-serif">Our Values</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">The principles that guide everything we do</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-serif">Quality</h3>
              <p className="text-gray-600 font-sans">We never compromise on excellence in every aspect of our business.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-serif">Hospitality</h3>
              <p className="text-gray-600 font-sans">Every guest is treated like family with warmth and genuine care.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-serif">Freshness</h3>
              <p className="text-gray-600 font-sans">Daily preparation using the freshest ingredients available.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-serif">Community</h3>
              <p className="text-gray-600 font-sans">Building connections and supporting our local neighborhood.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-amber-50 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 font-serif">Cafe Gallery</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">Moments that make Cherdung Cafe special</p>
          </div>
          ...
          {galleryImages.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600 font-sans">No gallery images available yet.</p>
            </div>
          )}
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 font-serif">Community Connection</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">How Cherdung Cafe supports and celebrates our local community</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-amber-50 p-8 rounded-lg">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 font-serif">Local Sourcing</h3>
              </div>
            ...
            <div className="bg-amber-50 p-8 rounded-lg">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 font-serif">Community Events</h3>
              </div>
              <p className="text-gray-600 font-sans">
            ...
            <div className="bg-amber-50 p-8 rounded-lg">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 font-serif">Supporting Local Causes</h3>
              </div>
              <p className="text-gray-600 font-sans">
            ...
            <div className="bg-amber-50 p-8 rounded-lg">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 font-serif">Creating Opportunities</h3>
              </div>
              <p className="text-gray-600 font-sans">
      ...
      <div className="lg:hidden bg-amber-50 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            href="/contact"
            className="flex items-center justify-center gap-2 px-6 py-3 bg-black text-white text-sm uppercase tracking-widest hover:bg-gray-800 transition-colors font-sans"
          >
