...
export default async function GalleryPage() {
  ...
  const fallbackImages: Image[] = [
    ...
    },
    {
      ...
      caption: "Signature specialty drinks",
      category: "Food & Coffee",
    },
  ]
