...
export const metadata: Metadata = {
  ...
  description:
    "Browse our photo gallery showcasing our cozy interior, delicious food, and memorable events at Cherdung Café.",
  openGraph: {
    title: "Our Gallery - Cherdung Café",
    description:
